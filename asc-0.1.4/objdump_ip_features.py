...
def extract_all_ips(objdump_infile):
    inf = open(objdump_infile, 'r')
    objdump_string = inf.read()
...
infile = sys.argv[1]
ips_dict, jmp_target_set = extract_all_ips(infile)
#print ips_dict
